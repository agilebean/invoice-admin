...
| **10.3** | **3** | **Gmail API** search + billing URL from message HTML | **`list-billing-mail`**, **`billing-url-from-gmail`** (prints payments URL); **`GOOGLEADS_OAUTH_TOKEN`**; optional **`GOOGLEADS_GMAIL_BILLING_QUERY`**. Verified end-to-end 2026-05-03: OAuth token generated, `list-billing-mail` returns billing messages. |
